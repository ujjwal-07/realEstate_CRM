            ...
            <tbody className="divide-y divide-slate-50">
              {filteredAndSortedLeads.map((lead) => (
                <tr key={lead._id} className="group hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-6 py-5">
                    <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${lead.status === 'New' ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' :
